...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        window?.rootViewController = UINavigationController(rootViewController: RouteFindingDetailViewController(routeDataDraft: RouteDataDraft(manager: RouteDataManager(), existingRouteFinding: nil)))
